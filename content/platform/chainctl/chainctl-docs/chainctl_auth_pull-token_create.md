...
```
chainctl auth pull-token create [--save=true|false] [--name=NAME] [--description=DESC] [--ttl=NUM_HOURS_ACTIVE] [--parent=PARENT] [--repository={oci|apk|go_athena|java|javascript|javascript_athena|dotnet|python|java_athena|python_athena|dotnet_athena|go}] [flags]
```
