...
All Chainguard FIPS Containers include [STIG hardening](/chainguard/containers/features/stigs/) in addition to FIPS validation. For images not currently available with FIPS, [contact Chainguard](https://www.chainguard.dev/contact) to discuss custom requirements.
