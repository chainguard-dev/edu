...
type: "article"
description: "Demo of the changelog with a product announcement, showing how a manually entered announcement appears at the top of a week."
...
{{< note >}}
This is a demo page — a copy of the changelog with a sample product announcement added to the top of the most recent week, to show how a manually entered announcement renders. It is not the live changelog; see the [Changelog](/chainguard/changelog/).
{{< /note >}}
