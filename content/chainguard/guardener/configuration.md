...
Guardener is configured entirely through files committed to the `.chainguard/` directory in each repository. This page explains the configuration model that all Guardener features share. For the specific options of each feature, see its dedicated page.
...
To add or update Guardener configuration:
