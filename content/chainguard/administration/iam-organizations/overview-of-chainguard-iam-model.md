...
There are several ways to authenticate to the Chainguard platform. Each has a different focus. Here is a list that includes the best use for and the pros and cons of each.
...
* [Assumable identities](/chainguard/administration/iam-organizations/assumable-ids/): These are good for CICD and do not require any interaction, but they do require more setting up and are not ideal outside of CICD use cases.
