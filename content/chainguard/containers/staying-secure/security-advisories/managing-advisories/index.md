...
- /chainguard/containers/working-with-images/security-advisories/managing-advisories/
- /chainguard/containers/staying-secure/security-advisories/managing-advisories/
type: "article"
...
The same process can be followed for other status updates, whether you wish to mark a vulnerability as “Not affected” in the case of a [false positive finding](/chainguard/containers/staying-secure/working-with-scanners/false-results/), “Fix not planned”, or another applicable status.
