...
- /chainguard/containers/working-with-images/security-advisories/how-chainguard-issues/
- /chainguard/containers/staying-secure/security-advisories/how-chainguard-issues/
type: "article"
...
With an advisory issued for the package, further investigation is often needed to determine the impact of the CVE. In some cases, it will be determined that the CVE is not truly present in the package, therefore making it a [false positive](/chainguard/containers/staying-secure/working-with-scanners/false-results/). The associated security advisory would have its status updated to "Not Affected", and further updates to the advisory would not occur.
...
/chainguard/containers/staying-secure/security-advisories/how-to-use/).
