...
toc: true
aliases:
- /chainguard/chainguard-images/staying-secure/enforcement/opa-gatekeeper/
- /chainguard/containers/staying-secure/enforcement/opa-gatekeeper/
---
...
> **Note**: If you want to use a private registry, you can follow the identity patterns laid out [for private and dedicated registries](/chainguard/containers/how-to-use/verifying-chainguard-images-and-metadata-signatures-with-cosign/#privatededicated-registry)
