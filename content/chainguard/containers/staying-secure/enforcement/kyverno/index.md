...
- /chainguard/containers/staying-secure/enforcement/kyverno/
---
...
To prevent the risk of updates introducing breaking changes, you can [pull by digest](/chainguard/containers/how-to-use/container-image-digests/) to ensure the use of a specific image. When using Kyverno, you can use a `ClusterPolicy` policy to ensure that images are only referenced by digest.
...
To begin, retrieve the IDs of the `image-syncer` and `custom-image-builder` identities for your organization as described [on this page](/chainguard/containers/how-to-use/verifying-chainguard-images-and-metadata-signatures-with-cosign/#chainguards-signing-identities).
