...
Dependabot and [Digestabot](/chainguard/containers/staying-secure/updating-images/digestabot/) solve different halves of the same problem, and many teams run both:
...
* [Using Renovate with Chainguard Containers](/chainguard/containers/staying-secure/updating-images/renovate/) covers the equivalent setup for teams outside GitHub, or teams that want short-lived credentials through an assumable identity.
