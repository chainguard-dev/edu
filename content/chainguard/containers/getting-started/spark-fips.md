...
- /chainguard/containers/getting-started/spark-fips/
---
...
For production clusters, configure an image pull secret for `cgr.dev` rather than pre-loading images. Refer to the [Chainguard registry authentication documentation](/chainguard/containers/chainguard-registry/authenticating/) for details.
