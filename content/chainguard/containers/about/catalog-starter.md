...
- /chainguard/containers/about/catalog-starter/
---
...
* [Catalog pricing](/chainguard/containers/about/pricing/) — a subscription that grants broad access to the full Chainguard Containers catalog with self-service provisioning through the Console.
...
* Users in a Catalog Starter organization are assigned the `limited_owner` role, which allows them to browse the Console, pull images, and create pull tokens, but does not include permission to invite other users to the organization or access features like [Custom Assembly](/chainguard/containers/features/custom-assembly/).
