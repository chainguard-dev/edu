...
- /chainguard/containers/about/images-categories/
---
...
> **Note**: Base Containers often require more customization by the user. Be aware that Chainguard offers a customization platform called [Custom Assembly](/chainguard/containers/features/ca-docs/custom-assembly/) to streamline this requirement without customers having to stand up their own custom pipelines.
...
1. Using [incert](/chainguard/containers/features/incert-custom-certs/)
...
For more information on Chainguard Containers, please refer to the other resources in the [About section](/chainguard/containers/about/). In particular, you may find our conceptual article on [Chainguard's Shared Responsibility Model](/chainguard/containers/about/shared-responsibility-model/) to be of interest.
