---
title: "Choosing a base container for your compiled programs"
linktitle: "Choosing a base container"
aliases:
...
- /chainguard/chainguard-images/about/images-compiled-programs/compiled-programs/
- /chainguard/containers/working-with-images/compiled-programs/
- /chainguard/containers/working-with-images/images-compiled-programs/compiled-programs
- /chainguard/containers/working-with-images/about/images-compiled-programs/compiled-programs
- /chainguard/containers/about/images-compiled-programs/compiled-programs/
...
- /chainguard/chainguard-images/about/images-compiled-programs/
- /chainguard/containers/working-with-images/images-compiled-programs
- /chainguard/containers/working-with-images/about/images-compiled-programs
- /chainguard/containers/about/images-compiled-programs/
type: "article"
...
Though `musl` is sometimes chosen because of its minimal footprint, Chainguard’s distroless approach based on [Wolfi](https://www.chainguard.dev/unchained/introducing-wolfi-the-first-linux-un-distro) often results in a container image of comparable (or smaller) size than official `musl` based images. For more information, please refer to our [glibc vs. musl](/chainguard/containers/about/glibc-vs-musl/) article.
