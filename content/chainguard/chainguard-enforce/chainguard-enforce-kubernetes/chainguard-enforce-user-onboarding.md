...
With `chainctl` successfully installed, we can continue through the demo. For more details on `chainctl` installtion, please review [How to Install chainctl for Chainguard Enforce](https://edu.chainguard.dev/chainguard/chainguard-enforce/chainctl-docs/how-to-install-chainctl/).
