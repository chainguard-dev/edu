...
Follow the steps detailed in [Manual Access](#manual) to browse the
simple Python index and find available packages, package versions, source
distribution (sdist) and Python wheel files for standard and remediated
package version.
