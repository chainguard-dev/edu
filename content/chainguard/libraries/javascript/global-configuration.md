...
* An AWS account with permission to create and manage CodeArtifact domains and repositories, and to request CodeArtifact authorization tokens and repository endpoints.
