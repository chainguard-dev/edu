...
This Chainguard Libraries for JavaScript repository uses the npm repository format
...
The Chainguard Libraries for JavaScript repository does not include all
artifacts from the npm registry and other repositories.
