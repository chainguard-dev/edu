...
supply chain attacks surface points:
...
More information about the stages is available on the [Supply chain Levels for
Software Artifacts (SLSA) website](https://slsa.dev/).

Following are examples that exploited issues in the relevant supply
chain:

**Example: Ultralytics Python project**
...
* Affected a widely-used AI library with ~60 million downloads included a cryptominer.
* No source code was included and Chainguard Libraries would therefore block.
...
* Hackers gained access to NPM registry by compromising a developer authentication token.
* Used token to upload a compromised version of Lottie Player.
...
* All Maven-based software, including Gradle and Ant, is compromised.
