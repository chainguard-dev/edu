...
Chainguard can not patch Java libraries and create binaries with the same
...
CVE. Chainguard Libraries for Java includes those newest versions and adds the
