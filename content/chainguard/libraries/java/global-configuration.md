...
Use the following steps to add the Chainguard Libraries for Java repository:
...
Now the repository is ready and you can add it to the group:

1. Select **Repository - Repositories** in the left hand navigation.
1. Click on the *maven-public* repository group.
1. In the section **Group - Member repositories**, move the new chainguard
   repository to the right and to the top of the list with the arrow control.

Use the URL of the repository group, such as
*https://repo.example.com/repository/maven-public/* in the [build
configuration](/chainguard/libraries/java/build-configuration) and build a
first test project. In a working setup the chainguard proxy repository contains
