...
Before running a new build, you must configure access to the Chainguard
Libraries for Java. If the administrator for your organization’s repository
manager created a new repository or virtual repository, you must update your
Bazel configuration to use the repository manager.
...
Refer to the [official Bazel documentation for rules_jvm_external]() for more
