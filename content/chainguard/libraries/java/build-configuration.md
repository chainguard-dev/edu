...
hidden .m2/repository directory in your users home directory. Use the following
...
the mirror configuration. Username and password value vary depending on the
...
repository, you can trigger a build to initiate use of the Chainguard Libraries
for Java.
...
default the cache is located in a hidden .gradle/.cache directory in your users
home directory. Use the following command to delete it:
...
configuration in the global init.gradle or a project specific build.gradle file:
