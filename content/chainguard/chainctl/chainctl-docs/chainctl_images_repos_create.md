...
```
chainctl images repos create {REPO_NAME} --parent ORGANIZATION_NAME | ORGANIZATION_ID | FOLDER_NAME | FOLDER_ID --tier=AI|DEVTOOLS|COMMERCIAL|APPLICATION|BASE|FIPS
```
