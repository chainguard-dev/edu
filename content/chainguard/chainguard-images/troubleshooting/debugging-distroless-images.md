...
## 1. Using Starter Image Variants
...
The Starter variants of [Chainguard Container Images](/chainguard/chainguard-images/) (sometimes referred to as `-dev` images, as they are tagged with `:latest-dev`) are designed to replicate the same packages of their distroless version, but with additional software that helps in developing, building, and debugging applications in different language ecosystems.
