...
The non-interactive approach is particularly useful for CI/CD pipelines and automation. You can also perform bulk operations across multiple repos, see [Making bulk changes across repos](/chainguard/chainguard-images/features/ca-docs/custom-assembly-chainctl/#making-bulk-changes-across-repos).
