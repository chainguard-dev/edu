...
- Custom certificates: Add trusted certificates [to existing containers via Custom Assembly](/chainguard/chainguard-images/features/ca-docs/custom-assembly-certs/) (for organization-specific or environment-specific certificates) or by [using incert to build images with certificates embedded at build time](/chainguard/chainguard-images/features/incert-custom-certs/).
