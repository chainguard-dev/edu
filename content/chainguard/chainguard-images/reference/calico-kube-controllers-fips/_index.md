---
title: "Image Overview: calico-kube-controllers-fips"
linktitle: "calico-kube-controllers-fips"
type: "article"
layout: "single"
description: "Overview: calico-kube-controllers-fips Chainguard Image"
...
{{< tabs >}}
{{< tab title="Overview" active=true url="/chainguard/chainguard-images/reference/calico-kube-controllers-fips/" >}}
...
```
docker pull cgr.dev/chainguard-private/calico-kube-controllers-fips:latest
```
