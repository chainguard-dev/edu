...
type: "article"
description: "Provenance information for Kubernetes-csi-external-resizer Chainguard Images"
...
```shell
cosign download sbom --platform linux/amd64 cgr.dev/chainguard/kubernetes-csi-external-resizer | jq
```
