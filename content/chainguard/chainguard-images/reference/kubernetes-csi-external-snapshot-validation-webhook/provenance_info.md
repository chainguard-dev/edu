...
type: "article"
description: "Provenance information for Kubernetes-csi-external-snapshot-validation-webhook Chainguard Images"
...
```shell
cosign download sbom --platform linux/amd64 cgr.dev/chainguard/kubernetes-csi-external-snapshot-validation-webhook | jq
```
