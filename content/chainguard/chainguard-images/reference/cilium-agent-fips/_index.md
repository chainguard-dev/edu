---
title: "Image Overview: cilium-agent-fips"
linktitle: "cilium-agent-fips"
type: "article"
layout: "single"
description: "Overview: cilium-agent-fips Chainguard Image"
...
{{< tabs >}}
{{< tab title="Overview" active=true url="/chainguard/chainguard-images/reference/cilium-agent-fips/" >}}
...
```
docker pull cgr.dev/chainguard-private/cilium-agent-fips:latest
```
