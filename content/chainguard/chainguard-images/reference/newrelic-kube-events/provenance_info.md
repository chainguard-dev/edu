...
type: "article"
description: "Provenance information for Newrelic-kube-events Chainguard Images"
...
```shell
cosign download sbom --platform linux/amd64 cgr.dev/chainguard/newrelic-kube-events | jq
```
