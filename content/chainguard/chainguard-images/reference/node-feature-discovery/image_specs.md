---
title: "node-feature-discovery Image Details"
type: "article"
unlisted: true
...
{{< tab title="Details" active=true url="/chainguard/chainguard-images/reference/node-feature-discovery/image_specs/" >}}
...
This page shows detailed information about the Chainguard **node-feature-discovery** Image.
...
Check the [tags history page](/chainguard/chainguard-images/reference/node-feature-discovery/tags_history/) for the full list of available tags.
...
| `node-feature-discovery-0.16` | X          | X      |
| `wget`                        | X          |        |
