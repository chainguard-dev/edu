---
title: "Image Overview: cert-manager-cmctl-fips"
linktitle: "cert-manager-cmctl-fips"
type: "article"
layout: "single"
description: "Overview: cert-manager-cmctl-fips Chainguard Image"
...
{{< tabs >}}
{{< tab title="Overview" active=true url="/chainguard/chainguard-images/reference/cert-manager-cmctl-fips/" >}}
...
```
docker pull cgr.dev/chainguard-private/cert-manager-cmctl-fips:latest
```
