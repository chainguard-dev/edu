---
title: "Image Overview: prometheus-config-reloader-fips"
linktitle: "prometheus-config-reloader-fips"
type: "article"
layout: "single"
description: "Overview: prometheus-config-reloader-fips Chainguard Image"
...
{{< tabs >}}
{{< tab title="Overview" active=true url="/chainguard/chainguard-images/reference/prometheus-config-reloader-fips/" >}}
...
```
docker pull cgr.dev/chainguard-private/prometheus-config-reloader-fips:latest
```
