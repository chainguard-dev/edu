---
title: "istio-pilot-fips Image Details"
type: "article"
unlisted: true
...
{{< tab title="Details" active=true url="/chainguard/chainguard-images/reference/istio-pilot-fips/image_specs/" >}}
...
This page shows detailed information about the Chainguard **istio-pilot-fips** Image.
...
Check the [tags history page](/chainguard/chainguard-images/reference/istio-pilot-fips/tags_history/) for the full list of available tags.
...
| `istio-pilot-discovery-1.22-compat` | X          | X      |
| `istio-pilot-discovery-fips-1.22`   | X          | X      |
| `ld-linux`                          | X          | X      |
| `libbrotlicommon1`                  | X          |        |
| `libbrotlidec1`                     | X          |        |
| `libcrypt1`                         | X          |        |
