...
| `cgr.dev/chainguard-private` | 1, 1-dev, 1.30, 1.30-dev, 1.30.10, 1.30.10-dev, 1.30.2, 1.30.2-dev, 1.30.3, 1.30.3-dev, 1.30.4, 1.30.4-dev, 1.30.5, 1.30.5-dev, 1.30.7, 1.30.7-dev, 1.30.8, 1.30.8-dev, 1.30.9, 1.30.9-dev, 1.31, 1.31-dev, 1.31.0, 1.31.0-dev, 1.31.1, 1.31.1-dev, 1.31.2, 1.31.2-dev, 1.32, 1.32-dev, 1.32.4, 1.32.4-dev, 1.32.5, 1.32.5-dev, 1.32.6, 1.32.6-dev, 1.32.7, 1.32.7-dev, 1.32.8, 1.32.8-dev, 1.33, 1.33-dev, 1.33.0, 1.33.0-dev, latest, latest-dev, v1, v1-dev, v1.30, v1.30-dev, v1.30.10, v1.30.10-dev, v1.30.7-dev, v1.30.8, v1.30.8-dev, v1.30.9, v1.30.9-dev, v1.31, v1.31-dev, v1.31.2, v1.31.2-dev, v1.32, v1.32-dev, v1.32.4, v1.32.4-dev, v1.32.5, v1.32.5-dev, v1.32.6, v1.32.6-dev, v1.32.7, v1.32.7-dev, v1.32.8, v1.32.8-dev, v1.33, v1.33-dev, v1.33.0, v1.33.0-dev, vlatest, vlatest-dev |
