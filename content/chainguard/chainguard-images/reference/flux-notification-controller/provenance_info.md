...
type: "article"
description: "Provenance information for Flux-notification-controller Chainguard Images"
...
```shell
cosign download sbom --platform linux/amd64 cgr.dev/chainguard/flux-notification-controller | jq
```
