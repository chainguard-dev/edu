...
type: "article"
description: "Provenance information for Newrelic-prometheus-configurator Chainguard Images"
...
```shell
cosign download sbom --platform linux/amd64 cgr.dev/chainguard/newrelic-prometheus-configurator | jq
```
