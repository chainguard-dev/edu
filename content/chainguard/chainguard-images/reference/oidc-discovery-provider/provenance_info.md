...
type: "article"
description: "Provenance information for Oidc-discovery-provider Chainguard Images"
...
```shell
cosign download sbom --platform linux/amd64 cgr.dev/chainguard/oidc-discovery-provider | jq
```
