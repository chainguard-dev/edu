...
| Tag (s)                                                                                                                                                    | Last Changed | Digest                                                                    |
|------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|---------------------------------------------------------------------------|
|  `2.45.0` `2.45` `2` `latest` `glibc-2.45` `glibc-2.45.0` `glibc-2` `latest-glibc`                                                                         | May 2nd      | `sha256:8700bd485649a36d07f6af35e3e1597eda7a6f9a304082ab1dc5faa6a44d766c` |
|  `2.45.0-dev` `2.45-dev` `latest-dev` `2-dev` `latest-glibc-dev` `glibc-2.45.0-dev` `glibc-2.45-dev` `glibc-2-dev`                                         | May 2nd      | `sha256:1a1ae60b3ddaa60b211214f621278dd43f1ca932071664979894601100c1277b` |
|  `latest-root` `root-2.45.0` `root-2` `root-2.45` `glibc-root-2.45` `latest-glibc-root` `glibc-root-2.45.0` `glibc-root-2`                                 | May 2nd      | `sha256:67a4d16893976d0c1ca49c11680403938802d432ec63c786aac69ee7fd68c4cc` |
|  `root-2.45.0-dev` `root-2-dev` `latest-root-dev` `root-2.45-dev` `glibc-root-2-dev` `glibc-root-2.45-dev` `latest-glibc-root-dev` `glibc-root-2.45.0-dev` | May 2nd      | `sha256:a0f57a88cb9ec1734723925e72ebe35df31f05ac7e29b4acf37660faa8a4b76f` |
