...
| `latest-glibc`      | `glibc-2`, `glibc-2.40`, `glibc-2.40.1`, `glibc-2.40.1-r0`                     |
| `latest-glibc-dev`  | `glibc-2-dev`, `glibc-2.40-dev`, `glibc-2.40.1-dev`, `glibc-2.40.1-r0-dev`     |
| `latest-root`       | `root-2`, `root-2.40`, `root-2.40.1`, `root-2.40.1-r0`                         |
| `latest-glibc-root` | `glibc-root-2`, `glibc-root-2.40`, `glibc-root-2.40.1`, `glibc-root-2.40.1-r0` |
