...
type: "article"
description: "Provenance information for Kyverno-background-controller Chainguard Images"
...
```shell
cosign download sbom --platform linux/amd64 cgr.dev/chainguard/kyverno-background-controller | jq
```
