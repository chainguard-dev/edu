...
| `cgr.dev/chainguard-private` | 2, 2-dev, 2.23, 2.23-dev, 2.23.0, 2.23.0-dev, 2.24, 2.24-dev, 2.24.0, 2.24.0-dev, 2.25, 2.25-dev, 2.25.0, 2.25.0-dev, 2.26, 2.26-dev, 2.26.0, 2.26.0-dev, 2.26.1, 2.26.1-dev, 2.26.2, 2.26.2-dev, 2.27, 2.27-dev, 2.27.0, 2.27.0-dev, 2.27.1, 2.27.1-dev, latest, latest-dev |
