---
title: "tekton-chains Image Details"
type: "article"
unlisted: true
description: "Detailed information about the public tekton-chains Chainguard Image."
...
{{< tab title="Details" active=true url="/chainguard/chainguard-images/reference/tekton-chains/image_specs/" >}}
...
This page shows detailed information about the Chainguard **tekton-chains** Image.

|              | latest-dev               |
|--------------|--------------------------|
| Default User | `nonroot`                |
| Entrypoint   | `/usr/bin/tekton-chains` |
| CMD          | not specified            |
