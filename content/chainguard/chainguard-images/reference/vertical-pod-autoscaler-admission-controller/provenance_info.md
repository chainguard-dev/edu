...
type: "article"
description: "Provenance information for Vertical-pod-autoscaler-admission-controller Chainguard Images"
...
```shell
cosign download sbom --platform linux/amd64 cgr.dev/chainguard/vertical-pod-autoscaler-admission-controller | jq
```
