...
| `cgr.dev/chainguard-private` | 3, 3-dev, 3.5, 3.5-dev, 3.5.0, 3.5.0-dev, 3.5.1, 3.5.1-dev, 3.5.2, 3.5.2-dev, 3.5.3, 3.5.3-dev, 3.5.4, 3.5.4-dev, 3.5.5, 3.5.5-dev, 3.5.6, 3.5.6-dev, latest, latest-dev |
