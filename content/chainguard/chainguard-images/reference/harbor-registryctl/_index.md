---
title: "Image Overview: harbor-registryctl"
linktitle: "harbor-registryctl"
type: "article"
layout: "single"
description: "Overview: harbor-registryctl Chainguard Image"
...
{{< tabs >}}
{{< tab title="Overview" active=true url="/chainguard/chainguard-images/reference/harbor-registryctl/" >}}
...
```
docker pull cgr.dev/chainguard/harbor-registryctl:latest
```
