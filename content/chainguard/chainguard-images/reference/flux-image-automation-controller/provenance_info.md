...
type: "article"
description: "Provenance information for Flux-image-automation-controller Chainguard Images"
...
```shell
cosign download sbom --platform linux/amd64 cgr.dev/chainguard/flux-image-automation-controller | jq
```
