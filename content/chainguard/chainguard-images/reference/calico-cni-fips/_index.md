---
title: "Image Overview: calico-cni-fips"
linktitle: "calico-cni-fips"
type: "article"
layout: "single"
description: "Overview: calico-cni-fips Chainguard Image"
...
{{< tabs >}}
{{< tab title="Overview" active=true url="/chainguard/chainguard-images/reference/calico-cni-fips/" >}}
...
```
docker pull cgr.dev/chainguard-private/calico-cni-fips:latest
```
