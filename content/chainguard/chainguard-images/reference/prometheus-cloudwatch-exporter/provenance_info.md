...
type: "article"
description: "Provenance information for Prometheus-cloudwatch-exporter Chainguard Images"
...
```shell
cosign download sbom --platform linux/amd64 cgr.dev/chainguard/prometheus-cloudwatch-exporter | jq
```
