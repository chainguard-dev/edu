...
type: "article"
description: "Provenance information for prometheus-alertmanager Chainguard Images"
...
```shell
cosign download sbom --platform linux/amd64 cgr.dev/chainguard/prometheus-alertmanager | jq
```
