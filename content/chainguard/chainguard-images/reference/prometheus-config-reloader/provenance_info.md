...
type: "article"
description: "Provenance information for Prometheus-config-reloader Chainguard Images"
...
```shell
cosign download sbom --platform linux/amd64 cgr.dev/chainguard/prometheus-config-reloader | jq
```
