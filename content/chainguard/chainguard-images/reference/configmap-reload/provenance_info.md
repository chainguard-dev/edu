...
type: "article"
description: "Provenance information for Configmap-reload Chainguard Images"
...
```shell
cosign download sbom --platform linux/amd64 cgr.dev/chainguard/configmap-reload | jq
```
