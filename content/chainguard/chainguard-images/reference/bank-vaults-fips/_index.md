---
title: "Image Overview: bank-vaults-fips"
linktitle: "bank-vaults-fips"
type: "article"
layout: "single"
description: "Overview: bank-vaults-fips Chainguard Image"
...
{{< tabs >}}
{{< tab title="Overview" active=true url="/chainguard/chainguard-images/reference/bank-vaults-fips/" >}}
...
```
docker pull cgr.dev/chainguard-private/bank-vaults-fips:latest
```
