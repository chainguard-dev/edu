...
| `cgr.dev/chainguard-private` | 2, 2-dev, 2.8, 2.8-dev, 2.8.4, 2.8.4-dev, 2.9, 2.9-dev, 2.9.5, 2.9.5-dev, 2.9.6, 2.9.6-dev, 2.9.8, 2.9.8-dev, 3, 3-dev, 3.0, 3.0-dev, 3.0.0, 3.0.0-dev, latest, latest-dev |
