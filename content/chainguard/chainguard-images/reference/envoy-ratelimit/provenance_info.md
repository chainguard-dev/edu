...
type: "article"
description: "Provenance information for Envoy-ratelimit Chainguard Images"
...
```shell
cosign download sbom --platform linux/amd64 cgr.dev/chainguard/envoy-ratelimit | jq
```
