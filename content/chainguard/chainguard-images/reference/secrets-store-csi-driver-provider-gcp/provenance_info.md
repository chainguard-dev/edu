...
type: "article"
description: "Provenance information for Secrets-store-csi-driver-provider-gcp Chainguard Images"
...
```shell
cosign download sbom --platform linux/amd64 cgr.dev/chainguard/secrets-store-csi-driver-provider-gcp | jq
```
