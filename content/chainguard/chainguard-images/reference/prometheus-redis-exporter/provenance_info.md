...
type: "article"
description: "Provenance information for Prometheus-redis-exporter Chainguard Images"
...
```shell
cosign download sbom --platform linux/amd64 cgr.dev/chainguard/prometheus-redis-exporter | jq
```
