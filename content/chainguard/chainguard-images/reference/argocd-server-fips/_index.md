---
title: "Image Overview: argocd-server-fips"
linktitle: "argocd-server-fips"
type: "article"
layout: "single"
description: "Overview: argocd-server-fips Chainguard Image"
...
{{< tabs >}}
{{< tab title="Overview" active=true url="/chainguard/chainguard-images/reference/argocd-server-fips/" >}}
...
```
docker pull cgr.dev/chainguard-private/argocd-server-fips:latest
```
