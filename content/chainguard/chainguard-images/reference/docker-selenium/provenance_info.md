...
| `cgr.dev/chainguard-private` | 4, 4-dev, 4.18, 4.18-dev, 4.18.0, 4.18.0-dev, 4.18.1, 4.18.1-dev, 4.19, 4.19-dev, 4.19.0, 4.19.0-dev, 4.19.1, 4.19.1-dev, 4.20, 4.20-dev, 4.20.0, 4.20.0-dev, latest, latest-dev |
...
cgr.dev/chainguard-private/docker-selenium | jq
```
...
--platform=linux/amd64 \
--predicate-type=https://spdx.dev/Document \
cgr.dev/chainguard-private/docker-selenium | jq -r .payload | base64 -d | jq .predicate
```
...
--certificate-oidc-issuer=https://token.actions.githubusercontent.com \
--certificate-identity=https://github.com/chainguard-images/images-private/.github/workflows/release.yaml@refs/heads/main \
cgr.dev/chainguard-private/docker-selenium
```
