...
type: "article"
description: "Provenance information for Newrelic-fluent-bit-output Chainguard Images"
...
```shell
cosign download sbom --platform linux/amd64 cgr.dev/chainguard/newrelic-fluent-bit-output | jq
```
