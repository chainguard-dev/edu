...
type: "article"
description: "Provenance information for Kyverno-reports-controller Chainguard Images"
...
```shell
cosign download sbom --platform linux/amd64 cgr.dev/chainguard/kyverno-reports-controller | jq
```
