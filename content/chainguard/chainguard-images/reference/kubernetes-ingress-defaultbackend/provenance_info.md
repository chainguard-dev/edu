...
type: "article"
description: "Provenance information for Kubernetes-ingress-defaultbackend Chainguard Images"
...
```shell
cosign download sbom --platform linux/amd64 cgr.dev/chainguard/kubernetes-ingress-defaultbackend | jq
```
