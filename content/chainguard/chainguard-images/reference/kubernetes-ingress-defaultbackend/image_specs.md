---
title: "kubernetes-ingress-defaultbackend Image Details"
type: "article"
unlisted: true
description: "Detailed information about the public kubernetes-ingress-defaultbackend Chainguard Image."
...
{{< tab title="Details" active=true url="/chainguard/chainguard-images/reference/kubernetes-ingress-defaultbackend/image_specs/" >}}
...
This page shows detailed information about the Chainguard **kubernetes-ingress-defaultbackend** Image.
...
| `kubernetes-ingress-defaultbackend` | X          |
| `ld-linux`                          | X          |
| `libbrotlicommon1`                  | X          |
| `libbrotlidec1`                     | X          |
| `libcrypt1`                         | X          |
