---
title: "Image Overview: kubeflow-katib-db-manager"
linktitle: "kubeflow-katib-db-manager"
type: "article"
layout: "single"
description: "Overview: kubeflow-katib-db-manager Chainguard Image"
...
{{< tabs >}}
{{< tab title="Overview" active=true url="/chainguard/chainguard-images/reference/kubeflow-katib-db-manager/" >}}
...
```
docker pull cgr.dev/chainguard-private/kubeflow-katib-db-manager:latest
```
