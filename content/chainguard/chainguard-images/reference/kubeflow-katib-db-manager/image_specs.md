---
title: "kubeflow-katib-db-manager Image Details"
type: "article"
unlisted: true
description: "Detailed information about the public kubeflow-katib-db-manager Chainguard Image."
...
{{< tab title="Details" active=true url="/chainguard/chainguard-images/reference/kubeflow-katib-db-manager/image_specs/" >}}
...
This page shows detailed information about the Chainguard **kubeflow-katib-db-manager** Image.
...
| `grpc-health-probe`        | X          |
| `grpc-health-probe-compat` | X          |
| `katib-db-manager`         | X          |
| `katib-db-manager-compat`  | X          |
| `ld-linux`                 | X          |
| `libbrotlicommon1`         | X          |
| `libbrotlidec1`            | X          |
| `libcrypt1`                | X          |
