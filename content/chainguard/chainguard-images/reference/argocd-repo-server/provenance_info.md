...
type: "article"
description: "Provenance information for Argocd-repo-server Chainguard Images"
...
```shell
cosign download sbom --platform linux/amd64 cgr.dev/chainguard/argocd-repo-server | jq
```
