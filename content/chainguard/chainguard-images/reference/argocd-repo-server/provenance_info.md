...
| `cgr.dev/chainguard-private` | 2, 2-dev, 2.10, 2.10-dev, 2.10.12, 2.10.12-dev, 2.10.13, 2.10.13-dev, 2.11, 2.11-dev, 2.11.3, 2.11.3-dev, 2.11.4, 2.11.4-dev, 2.8, 2.8-dev, 2.8.18, 2.8.18-dev, 2.9, 2.9-dev, 2.9.17, 2.9.17-dev, 2.9.18, 2.9.18-dev, latest, latest-dev |
