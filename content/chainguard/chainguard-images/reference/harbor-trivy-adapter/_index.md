---
title: "Image Overview: harbor-trivy-adapter"
linktitle: "harbor-trivy-adapter"
type: "article"
layout: "single"
...
{{< tabs >}}
{{< tab title="Overview" active=true url="/chainguard/chainguard-images/reference/harbor-trivy-adapter/" >}}
...
```
docker pull cgr.dev/chainguard/harbor-trivy-adapter:latest
```
