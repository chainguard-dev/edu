...
type: "article"
description: "Provenance information for Haproxy-ingress Chainguard Images"
...
```shell
cosign download sbom --platform linux/amd64 cgr.dev/chainguard/haproxy-ingress | jq
```
