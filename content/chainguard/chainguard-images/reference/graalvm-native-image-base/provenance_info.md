---
title: "Provenance Information for graalvm-native-image-base Images"
type: "article"
description: "Provenance information for graalvm-native-image-base Chainguard Images"
...
menu:
  docs:
    parent: "graalvm-native-image-base"
weight: 600
toc: true
---
...
The **graalvm-native-image-base** Chainguard Images are signed using Sigstore, and you can check the included signatures using `cosign`.
...
```shell
COSIGN_EXPERIMENTAL=1 cosign verify cgr.dev/chainguard/graalvm-native-image-base | jq
```
...
```shell
cosign download sbom --platform linux/amd64 cgr.dev/chainguard/graalvm-native-image-base | jq
```
