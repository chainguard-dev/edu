---
title: "redis-bitnami-fips-server-bitnami Image Details"
type: "article"
unlisted: true
description: "Detailed information about the public redis-bitnami-fips-server-bitnami Chainguard Image."
...
{{< tab title="Details" active=true url="/chainguard/chainguard-images/reference/redis-bitnami-fips-server-bitnami/image_specs/" >}}
...
This page shows detailed information about the Chainguard **redis-bitnami-fips-server-bitnami** Image.
...
Check the [tags history page](/chainguard/chainguard-images/reference/redis-bitnami-fips-server-bitnami/tags_history/) for the full list of available tags.
