...
type: "article"
description: "Provenance information for Newrelic-k8s-events-forwarder Chainguard Images"
...
```shell
cosign download sbom --platform linux/amd64 cgr.dev/chainguard/newrelic-k8s-events-forwarder | jq
```
