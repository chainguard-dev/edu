...
{{< tabs >}}
{{< tab title="Overview" active=true url="/chainguard/chainguard-images/reference/tekton-resolvers/" >}}
...
```
docker pull cgr.dev/chainguard/tekton-resolvers:latest
```
