---
title: "Image Overview: grafana-fips"
linktitle: "grafana-fips"
type: "article"
layout: "single"
description: "Overview: grafana-fips Chainguard Image"
...
{{< tabs >}}
{{< tab title="Overview" active=true url="/chainguard/chainguard-images/reference/grafana-fips/" >}}
...
```
docker pull cgr.dev/chainguard-private/grafana-fips:latest
```
