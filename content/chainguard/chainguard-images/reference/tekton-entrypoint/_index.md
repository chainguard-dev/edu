...
{{< tabs >}}
{{< tab title="Overview" active=true url="/chainguard/chainguard-images/reference/tekton-entrypoint/" >}}
...
```
docker pull cgr.dev/chainguard/tekton-entrypoint:latest
```
