...
| `cgr.dev/chainguard-private` | 1, 1-dev, 1.11, 1.11-dev, 1.11.1, 1.11.1-dev, 1.11.2, 1.11.2-dev, 1.11.4, 1.11.4-dev, 1.11.5, 1.11.5-dev, 1.12, 1.12-dev, 1.12.0, 1.12.0-dev, 1.12.1, 1.12.1-dev, 1.12.2, 1.12.2-dev, 1.12.3, 1.12.3-dev, 1.12.4, 1.12.4-dev, 1.12.5, 1.12.5-dev, 1.12.6, 1.12.6-dev, 1.12.7, 1.12.7-dev, 1.13, 1.13-dev, 1.13.1, 1.13.1-dev, 1.13.2, 1.13.2-dev, 1.13.3, 1.13.3-dev, 1.13.4, 1.13.4-dev, 1.13.5, 1.13.5-dev, 1.14, 1.14-dev, 1.14.2, 1.14.2-dev, 1.14.4, 1.14.4-dev, latest, latest-dev |
