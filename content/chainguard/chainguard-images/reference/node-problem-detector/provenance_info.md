...
type: "article"
description: "Provenance information for Node-problem-detector Chainguard Images"
...
```shell
cosign download sbom --platform linux/amd64 cgr.dev/chainguard/node-problem-detector | jq
```
