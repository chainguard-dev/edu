---
title: "Image Overview: minio-client-fips"
linktitle: "minio-client-fips"
type: "article"
layout: "single"
description: "Overview: minio-client-fips Chainguard Image"
...
{{< tabs >}}
{{< tab title="Overview" active=true url="/chainguard/chainguard-images/reference/minio-client-fips/" >}}
...
```
docker pull cgr.dev/chainguard-private/minio-client-fips:latest
```
