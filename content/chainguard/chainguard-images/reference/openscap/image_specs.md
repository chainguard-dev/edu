...
{{< tab title="Details" active=true url="/chainguard/chainguard-images/reference/openscap/image_specs/" >}}
...
This page shows detailed information about the Chainguard **openscap** Image.

|              | latest-dev       | latest           |
|--------------|------------------|------------------|
| Default User | `nonroot`        | `nonroot`        |
| Entrypoint   | `/usr/bin/oscap` | `/usr/bin/oscap` |
| CMD          | not specified    | not specified    |
| Workdir      | not specified    | not specified    |
| Has apk?     | yes              | no               |
| Has a shell? | yes              | no               |

Check the [tags history page](/chainguard/chainguard-images/reference/openscap/tags_history/) for the full list of available tags.
