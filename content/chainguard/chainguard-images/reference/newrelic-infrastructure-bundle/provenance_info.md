...
type: "article"
description: "Provenance information for Newrelic-infrastructure-bundle Chainguard Images"
...
```shell
cosign download sbom --platform linux/amd64 cgr.dev/chainguard/newrelic-infrastructure-bundle | jq
```
