...
type: "article"
description: "Provenance information for Cluster-autoscaler Chainguard Images"
...
```shell
cosign download sbom --platform linux/amd64 cgr.dev/chainguard/cluster-autoscaler | jq
```
