...
type: "article"
description: "Provenance information for Aws-ebs-csi-driver Chainguard Images"
...
```shell
cosign download sbom --platform linux/amd64 cgr.dev/chainguard/aws-ebs-csi-driver | jq
```
