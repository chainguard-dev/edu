---
title: "Image Overview: cosign-fips"
linktitle: "cosign-fips"
type: "article"
layout: "single"
description: "Overview: cosign-fips Chainguard Image"
...
{{< tabs >}}
{{< tab title="Overview" active=true url="/chainguard/chainguard-images/reference/cosign-fips/" >}}
...
```
docker pull cgr.dev/chainguard-private/cosign-fips:latest
```
