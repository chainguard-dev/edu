...
type: "article"
description: "Provenance information for Vertical-pod-autoscaler-updater Chainguard Images"
...
```shell
cosign download sbom --platform linux/amd64 cgr.dev/chainguard/vertical-pod-autoscaler-updater | jq
```
