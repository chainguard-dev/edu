---
title: "Image Overview: redis-bitnami-sentinel-bitnami"
linktitle: "redis-bitnami-sentinel-bitnami"
type: "article"
layout: "single"
description: "Overview: redis-bitnami-sentinel-bitnami Chainguard Image"
...
{{< tabs >}}
{{< tab title="Overview" active=true url="/chainguard/chainguard-images/reference/redis-bitnami-sentinel-bitnami/" >}}
...
```
docker pull cgr.dev/chainguard/redis-bitnami-sentinel-bitnami:latest
```
