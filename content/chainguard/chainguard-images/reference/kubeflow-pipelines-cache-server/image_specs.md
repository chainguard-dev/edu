---
title: "kubeflow-pipelines-cache-server Image Details"
type: "article"
unlisted: true
description: "Detailed information about the public kubeflow-pipelines-cache-server Chainguard Image."
...
{{< tab title="Details" active=true url="/chainguard/chainguard-images/reference/kubeflow-pipelines-cache-server/image_specs/" >}}
...
This page shows detailed information about the Chainguard **kubeflow-pipelines-cache-server** Image.
...
| `kubeflow-pipelines-cache_server` | X          |
| `ld-linux`                        | X          |
| `libbrotlicommon1`                | X          |
| `libbrotlidec1`                   | X          |
| `libcrypt1`                       | X          |
