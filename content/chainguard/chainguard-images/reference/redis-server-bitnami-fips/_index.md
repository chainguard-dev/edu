---
title: "Image Overview: redis-server-bitnami-fips"
linktitle: "redis-server-bitnami-fips"
type: "article"
layout: "single"
description: "Overview: redis-server-bitnami-fips Chainguard Image"
...
{{< tabs >}}
{{< tab title="Overview" active=true url="/chainguard/chainguard-images/reference/redis-server-bitnami-fips/" >}}
...
```
docker pull cgr.dev/chainguard-private/redis-server-bitnami-fips:latest
```
