...
| `cgr.dev/chainguard-private` | 23, 23-dev, 23.5, 23.5-dev, 23.5.0, 23.5.0-dev, 23.5.2, 23.5.2-dev, 23.7, 23.7-dev, 23.7.0, 23.7.0-dev, 23.7.2, 23.7.2-dev, 23.7.3, 23.7.3-dev, 24, 24-dev, 24.1, 24.1-dev, 24.1.1, 24.1.1-dev, 24.1.2, 24.1.2-dev, 24.3, 24.3-dev, 24.3.0, 24.3.0-dev, 24.4, 24.4-dev, 24.4.0, 24.4.0-dev, latest, latest-dev |
