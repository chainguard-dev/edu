---
title: "oauth2-proxy Image Details"
type: "article"
unlisted: true
description: "Detailed information about the public oauth2-proxy Chainguard Image."
...
{{< tab title="Details" active=true url="/chainguard/chainguard-images/reference/oauth2-proxy/image_specs/" >}}
...
This page shows detailed information about the Chainguard **oauth2-proxy** Image.

|              | latest-dev              |
|--------------|-------------------------|
| Default User | `oauth2-proxy`          |
