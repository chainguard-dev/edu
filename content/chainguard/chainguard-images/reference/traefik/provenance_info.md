...
| `cgr.dev/chainguard-private` | 2, 2-dev, 2.10, 2.10-dev, 2.10.1, 2.10.3, 2.10.4, 2.10.5, 2.10.6, 2.10.7, 2.10.7-dev, 2.11, 2.11-dev, 2.11.0, 2.11.0-dev, 2.11.1, 2.11.1-dev, 2.11.2, 2.11.2-dev, 2.9, 2.9.10, 3, 3-dev, 3.0, 3.0-dev, 3.0.0, 3.0.0-dev, latest, latest-dev |
