---
title: "Image Overview: gha-runner-scale-set-controller-fips"
linktitle: "gha-runner-scale-set-controller-fips"
type: "article"
layout: "single"
description: "Overview: gha-runner-scale-set-controller-fips Chainguard Image"
...
{{< tabs >}}
{{< tab title="Overview" active=true url="/chainguard/chainguard-images/reference/gha-runner-scale-set-controller-fips/" >}}
...
```
docker pull cgr.dev/chainguard-private/gha-runner-scale-set-controller-fips:latest
```
