---
title: "Image Overview: redis-cluster-bitnami-fips"
linktitle: "redis-cluster-bitnami-fips"
type: "article"
layout: "single"
description: "Overview: redis-cluster-bitnami-fips Chainguard Image"
...
{{< tabs >}}
{{< tab title="Overview" active=true url="/chainguard/chainguard-images/reference/redis-cluster-bitnami-fips/" >}}
...
```
docker pull cgr.dev/chainguard-private/redis-cluster-bitnami-fips:latest
```
