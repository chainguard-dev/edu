---
title: "argocd-repo-server-fips Image Details"
type: "article"
unlisted: true
...
{{< tab title="Details" active=true url="/chainguard/chainguard-images/reference/argocd-repo-server-fips/image_specs/" >}}
...
This page shows detailed information about the Chainguard **argocd-repo-server-fips** Image.
...
Check the [tags history page](/chainguard/chainguard-images/reference/argocd-repo-server-fips/tags_history/) for the full list of available tags.
