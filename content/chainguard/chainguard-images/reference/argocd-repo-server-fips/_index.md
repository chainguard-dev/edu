---
title: "Image Overview: argocd-repo-server-fips"
linktitle: "argocd-repo-server-fips"
type: "article"
layout: "single"
description: "Overview: argocd-repo-server-fips Chainguard Image"
...
{{< tabs >}}
{{< tab title="Overview" active=true url="/chainguard/chainguard-images/reference/argocd-repo-server-fips/" >}}
...
```
docker pull cgr.dev/chainguard-private/argocd-repo-server-fips:latest
```
