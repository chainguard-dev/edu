---
title: "Image Overview: argocd-fips-repo-server"
linktitle: "argocd-fips-repo-server"
type: "article"
layout: "single"
description: "Overview: argocd-fips-repo-server Chainguard Image"
...
{{< tabs >}}
{{< tab title="Overview" active=true url="/chainguard/chainguard-images/reference/argocd-fips-repo-server/" >}}
...
```
docker pull cgr.dev/chainguard-private/argocd-fips-repo-server:latest
```
