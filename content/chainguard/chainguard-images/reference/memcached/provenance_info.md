...
| `cgr.dev/chainguard-private` | 1, 1-dev, 1.6, 1.6-dev, 1.6.19, 1.6.20, 1.6.21, 1.6.22, 1.6.24, 1.6.24-dev, 1.6.25, 1.6.25-dev, 1.6.26, 1.6.26-dev, 1.6.27, 1.6.27-dev, 1.6.28, 1.6.28-dev, latest, latest-dev |
