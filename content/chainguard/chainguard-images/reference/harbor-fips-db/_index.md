---
title: "Image Overview: harbor-fips-db"
linktitle: "harbor-fips-db"
type: "article"
layout: "single"
description: "Overview: harbor-fips-db Chainguard Image"
...
{{< tabs >}}
{{< tab title="Overview" active=true url="/chainguard/chainguard-images/reference/harbor-fips-db/" >}}
...
```
docker pull cgr.dev/chainguard-private/harbor-fips-db:latest
```
