...
### Registry and Tags for kubernetes-event-exporter Image
...
cgr.dev/chainguard-private/kubernetes-event-exporter | jq
```
...
--platform=linux/amd64 \
--predicate-type=https://spdx.dev/Document \
cgr.dev/chainguard-private/kubernetes-event-exporter | jq -r .payload | base64 -d | jq .predicate
```
...
--certificate-oidc-issuer=https://token.actions.githubusercontent.com \
--certificate-identity=https://github.com/chainguard-images/images-private/.github/workflows/release.yaml@refs/heads/main \
cgr.dev/chainguard-private/kubernetes-event-exporter
```
