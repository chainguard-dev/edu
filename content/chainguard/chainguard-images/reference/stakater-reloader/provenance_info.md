...
type: "article"
description: "Provenance information for Stakater-reloader Chainguard Images"
...
```shell
cosign download sbom --platform linux/amd64 cgr.dev/chainguard/stakater-reloader | jq
```
