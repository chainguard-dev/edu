...
| `cgr.dev/chainguard-private` | 1, 1-dev, 1.0, 1.0-dev, 1.0.108, 1.0.108-dev, 1.0.109, 1.0.109-dev, 1.0.113, 1.0.113-dev, 1.0.114, 1.0.114-dev, 1.0.115, 1.0.115-dev, latest, latest-dev |
