...
| `cgr.dev/chainguard-private` | 0, 0-dev, 0.0, 0.0-dev, 0.0.119, 0.0.119-dev, 0.0.128, 0.0.128-dev, 1, 1-dev, 1.0, 1.0-dev, 1.0.100, 1.0.100-dev, 1.0.101, 1.0.101-dev, 1.0.29, 1.0.29-dev, 1.0.30, 1.0.30-dev, 1.0.32, 1.0.32-dev, 1.0.34, 1.0.34-dev, 1.0.35, 1.0.35-dev, 1.0.36, 1.0.36-dev, 1.0.38, 1.0.38-dev, 1.0.39, 1.0.39-dev, 1.0.40, 1.0.40-dev, 1.0.41, 1.0.41-dev, 1.0.42, 1.0.42-dev, 1.0.43, 1.0.43-dev, 1.0.44, 1.0.44-dev, 1.0.46, 1.0.46-dev, 1.0.47, 1.0.47-dev, 1.0.48, 1.0.48-dev, 1.0.50, 1.0.50-dev, 1.0.51, 1.0.51-dev, 1.0.52, 1.0.52-dev, 1.0.53, 1.0.53-dev, 1.0.54, 1.0.54-dev, 1.0.56, 1.0.56-dev, 1.0.57, 1.0.57-dev, 1.0.58, 1.0.58-dev, 1.0.60, 1.0.60-dev, 1.0.62, 1.0.62-dev, 1.0.63, 1.0.63-dev, 1.0.64, 1.0.64-dev, 1.0.65, 1.0.65-dev, 1.0.67, 1.0.67-dev, 1.0.68, 1.0.68-dev, 1.0.69, 1.0.69-dev, 1.0.71, 1.0.71-dev, 1.0.72, 1.0.72-dev, 1.0.74, 1.0.74-dev, 1.0.75, 1.0.75-dev, 1.0.76, 1.0.76-dev, 1.0.77, 1.0.77-dev, 1.0.78, 1.0.78-dev, 1.0.79, 1.0.79-dev, 1.0.80, 1.0.80-dev, 1.0.82, 1.0.82-dev, 1.0.84, 1.0.84-dev, 1.0.87, 1.0.87-dev, 1.0.88, 1.0.88-dev, 1.0.90, 1.0.90-dev, 1.0.91, 1.0.91-dev, 1.0.92, 1.0.92-dev, 1.0.93, 1.0.93-dev, 1.0.94, 1.0.94-dev, 1.0.95, 1.0.95-dev, 1.0.97, 1.0.97-dev, 1.0.98, 1.0.98-dev, 1.0.99, 1.0.99-dev, latest, latest-dev |
