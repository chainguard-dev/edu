...
type: "article"
description: "Provenance information for Thanos-operator Chainguard Images"
...
```shell
cosign download sbom --platform linux/amd64 cgr.dev/chainguard/thanos-operator | jq
```
