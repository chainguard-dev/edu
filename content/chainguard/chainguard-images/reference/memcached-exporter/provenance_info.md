...
type: "article"
description: "Provenance information for Memcached-exporter Chainguard Images"
...
```shell
cosign download sbom --platform linux/amd64 cgr.dev/chainguard/memcached-exporter | jq
```
