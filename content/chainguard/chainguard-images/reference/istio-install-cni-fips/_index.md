---
title: "Image Overview: istio-install-cni-fips"
linktitle: "istio-install-cni-fips"
type: "article"
layout: "single"
description: "Overview: istio-install-cni-fips Chainguard Image"
...
{{< tabs >}}
{{< tab title="Overview" active=true url="/chainguard/chainguard-images/reference/istio-install-cni-fips/" >}}
...
```
docker pull cgr.dev/chainguard-private/istio-install-cni-fips:latest
```
