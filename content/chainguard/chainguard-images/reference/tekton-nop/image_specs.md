---
title: "tekton-nop Image Details"
type: "article"
unlisted: true
description: "Detailed information about the public tekton-nop Chainguard Image."
...
{{< tab title="Details" active=true url="/chainguard/chainguard-images/reference/tekton-nop/image_specs/" >}}
...
This page shows detailed information about the Chainguard **tekton-nop** Image.

|              | latest-dev                      |
|--------------|---------------------------------|
| Default User | `nonroot`                       |
| Entrypoint   | `/usr/bin/tekton-pipelines-nop` |
| CMD          | not specified                   |
