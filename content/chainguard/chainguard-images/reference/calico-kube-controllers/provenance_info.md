...
type: "article"
description: "Provenance information for Calico-kube-controllers Chainguard Images"
...
```shell
cosign download sbom --platform linux/amd64 cgr.dev/chainguard/calico-kube-controllers | jq
```
