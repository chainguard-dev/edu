---
title: "Image Overview: minio-fips"
linktitle: "minio-fips"
type: "article"
layout: "single"
description: "Overview: minio-fips Chainguard Image"
...
{{< tabs >}}
{{< tab title="Overview" active=true url="/chainguard/chainguard-images/reference/minio-fips/" >}}
...
```
docker pull cgr.dev/chainguard-private/minio-fips:latest
```
