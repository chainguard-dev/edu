---
title: "gpu-operator Image Details"
type: "article"
unlisted: true
...
{{< tab title="Details" active=true url="/chainguard/chainguard-images/reference/gpu-operator/image_specs/" >}}
...
This page shows detailed information about the Chainguard **gpu-operator** Image.

|              | latest-dev              | latest                  |
|--------------|-------------------------|-------------------------|
| Default User | `nonroot`               | `nonroot`               |
| Entrypoint   | `/usr/bin/gpu-operator` | `/usr/bin/gpu-operator` |
| CMD          | not specified           | not specified           |
| Workdir      | not specified           | not specified           |
| Has apk?     | yes                     | no                      |
| Has a shell? | yes                     | no                      |

Check the [tags history page](/chainguard/chainguard-images/reference/gpu-operator/tags_history/) for the full list of available tags.
