---
title: "Image Overview: coredns-fips"
linktitle: "coredns-fips"
type: "article"
layout: "single"
description: "Overview: coredns-fips Chainguard Image"
...
{{< tabs >}}
{{< tab title="Overview" active=true url="/chainguard/chainguard-images/reference/coredns-fips/" >}}
...
```
docker pull cgr.dev/chainguard-private/coredns-fips:latest
```
