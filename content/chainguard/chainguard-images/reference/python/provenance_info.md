...
| `cgr.dev/chainguard-private` | 3, 3-dev, 3-fips, 3-fips-dev, 3.10, 3.10-dev, 3.10-fips, 3.10-fips-dev, 3.10.11, 3.10.11-dev, 3.10.12, 3.10.12-dev, 3.10.12-fips, 3.10.12-fips-dev, 3.10.12-r0-fips, 3.10.12-r0-fips-dev, 3.10.13, 3.10.13-dev, 3.10.13-fips, 3.10.13-fips-dev, 3.10.13-r0-fips, 3.10.13-r0-fips-dev, 3.10.13-r1-fips, 3.10.13-r1-fips-dev, 3.10.14, 3.10.14-dev, 3.11, 3.11-dev, 3.11-fips, 3.11-fips-dev, 3.11.3, 3.11.3-dev, 3.11.4, 3.11.4-dev, 3.11.4-fips, 3.11.4-fips-dev, 3.11.4-r0-fips, 3.11.4-r0-fips-dev, 3.11.5, 3.11.5-dev, 3.11.5-fips, 3.11.5-fips-dev, 3.11.5-r0-fips, 3.11.5-r0-fips-dev, 3.11.5-r1-fips, 3.11.5-r1-fips-dev, 3.11.5-r2-fips, 3.11.5-r2-fips-dev, 3.11.6, 3.11.6-dev, 3.11.6-fips, 3.11.6-fips-dev, 3.11.6-r0-fips, 3.11.6-r0-fips-dev, 3.11.7, 3.11.7-dev, 3.11.8, 3.11.8-dev, 3.12, 3.12-dev, 3.12.0, 3.12.0-dev, 3.12.1, 3.12.1-dev, 3.12.2, 3.12.2-dev, 3.7, 3.7.16, 3.7.17, 3.8, 3.8-dev, 3.8-dev-dev, 3.8.10, 3.8.10-dev, 3.8.16, 3.8.16-dev, 3.8.17, 3.8.17-dev, 3.8.18, 3.8.18-dev, 3.8.19, 3.8.19-dev, 3.9, 3.9-dev, 3.9-dev-dev, 3.9.16, 3.9.16-dev, 3.9.17, 3.9.17-dev, 3.9.18, 3.9.18-dev, 3.9.19, 3.9.19-dev, latest, latest-dev, latest-fips, latest-fips-dev |
