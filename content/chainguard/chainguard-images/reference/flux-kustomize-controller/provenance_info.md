...
type: "article"
description: "Provenance information for Flux-kustomize-controller Chainguard Images"
...
```shell
cosign download sbom --platform linux/amd64 cgr.dev/chainguard/flux-kustomize-controller | jq
```
