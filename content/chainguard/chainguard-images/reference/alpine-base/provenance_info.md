---
title: "Provenance Information for alpine-base Images"
type: "article"
description: "Provenance information for alpine-base Chainguard Images"
...
The **alpine-base** Chainguard Images are signed using Sigstore, and you can check the included signatures using `cosign`.
...
```shell
COSIGN_EXPERIMENTAL=1 cosign verify cgr.dev/chainguard/alpine-base | jq
```
...
```shell
cosign download sbom --platform linux/amd64 cgr.dev/chainguard/alpine-base | jq
```
