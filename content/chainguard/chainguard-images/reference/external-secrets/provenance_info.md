...
type: "article"
description: "Provenance information for External-secrets Chainguard Images"
...
```shell
cosign download sbom --platform linux/amd64 cgr.dev/chainguard/external-secrets | jq
```
