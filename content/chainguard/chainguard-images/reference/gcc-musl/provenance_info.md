---
title: "Provenance Information for gcc-musl Images"
type: "article"
description: "Provenance information for Gcc-musl Chainguard Images"
...
The **gcc-musl** Chainguard Images are signed using Sigstore, and you can check the included signatures using `cosign`.
...
```shell
cosign download sbom --platform linux/amd64 cgr.dev/chainguard/gcc-musl | jq
```
