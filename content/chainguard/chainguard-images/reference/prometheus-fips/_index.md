---
title: "Image Overview: prometheus-fips"
linktitle: "prometheus-fips"
type: "article"
layout: "single"
description: "Overview: prometheus-fips Chainguard Image"
...
{{< tabs >}}
{{< tab title="Overview" active=true url="/chainguard/chainguard-images/reference/prometheus-fips/" >}}
...
```
docker pull cgr.dev/chainguard-private/prometheus-fips:latest
```
