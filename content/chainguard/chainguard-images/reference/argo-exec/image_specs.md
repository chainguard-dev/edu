---
title: "argo-exec Image Details"
type: "article"
unlisted: true
description: "Detailed information about the public argo-exec Chainguard Image."
...
{{< tab title="Details" active=true url="/chainguard/chainguard-images/reference/argo-exec/image_specs/" >}}
...
This page shows detailed information about the Chainguard **argo-exec** Image.
...
|---------------------------------|------------|
| `apk-tools`                     | X          |
| `argo-workflow-executor`        | X          |
| `argo-workflow-executor-compat` | X          |
