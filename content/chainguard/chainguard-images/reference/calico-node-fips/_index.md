---
title: "Image Overview: calico-node-fips"
linktitle: "calico-node-fips"
type: "article"
layout: "single"
description: "Overview: calico-node-fips Chainguard Image"
...
{{< tabs >}}
{{< tab title="Overview" active=true url="/chainguard/chainguard-images/reference/calico-node-fips/" >}}
...
```
docker pull cgr.dev/chainguard-private/calico-node-fips:latest
```
