...
type: "article"
description: "Provenance information for Aws-load-balancer-controller Chainguard Images"
...
```shell
cosign download sbom --platform linux/amd64 cgr.dev/chainguard/aws-load-balancer-controller | jq
```
