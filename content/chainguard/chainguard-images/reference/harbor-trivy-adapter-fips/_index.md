---
title: "Image Overview: harbor-trivy-adapter-fips"
linktitle: "harbor-trivy-adapter-fips"
type: "article"
layout: "single"
description: "Overview: harbor-trivy-adapter-fips Chainguard Image"
...
{{< tabs >}}
{{< tab title="Overview" active=true url="/chainguard/chainguard-images/reference/harbor-trivy-adapter-fips/" >}}
...
```
docker pull cgr.dev/chainguard-private/harbor-trivy-adapter-fips:latest
```
