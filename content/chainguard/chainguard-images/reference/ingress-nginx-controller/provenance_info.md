...
| `cgr.dev/chainguard-private` | 1, 1-dev, 1.10, 1.10-dev, 1.10.0, 1.10.0-dev, 1.8, 1.8-dev, 1.8.2, 1.8.2-dev, 1.9, 1.9-dev, 1.9.0, 1.9.0-dev, 1.9.1, 1.9.1-dev, 1.9.3, 1.9.3-dev, 1.9.4, 1.9.4-dev, 1.9.5, 1.9.5-dev, 1.9.6, 1.9.6-dev, latest, latest-dev |
