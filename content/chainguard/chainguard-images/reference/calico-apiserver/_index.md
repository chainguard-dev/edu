---
title: "Image Overview: calico-apiserver"
linktitle: "calico-apiserver"
type: "article"
layout: "single"
description: "Overview: calico-apiserver Chainguard Image"
...
{{< tabs >}}
{{< tab title="Overview" active=true url="/chainguard/chainguard-images/reference/calico-apiserver/" >}}
...
```
docker pull cgr.dev/chainguard-private/calico-apiserver:latest
```
