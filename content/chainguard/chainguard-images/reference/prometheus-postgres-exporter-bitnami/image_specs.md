...
|              | latest-dev                                         | latest                                             |
|--------------|----------------------------------------------------|----------------------------------------------------|
| Default User | `postgres-exporter`                                | `postgres-exporter`                                |
| Entrypoint   | `/opt/bitnami/postgres-exporter/postgres_exporter` | `/opt/bitnami/postgres-exporter/postgres_exporter` |
...
| `prometheus-postgres-exporter-bitnami-compat` | X          | X      |
| `wget`                                        | X          |        |
