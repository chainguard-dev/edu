...
type: "article"
description: "Provenance information for Kubernetes-csi-external-snapshot-controller Chainguard Images"
...
```shell
cosign download sbom --platform linux/amd64 cgr.dev/chainguard/kubernetes-csi-external-snapshot-controller | jq
```
