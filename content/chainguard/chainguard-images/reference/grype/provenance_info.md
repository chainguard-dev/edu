...
| `cgr.dev/chainguard-private` | 0, 0-dev, 0.73, 0.73-dev, 0.73.1, 0.73.1-dev, 0.73.2, 0.73.2-dev, 0.73.3, 0.73.3-dev, 0.73.4, 0.73.4-dev, 0.73.5, 0.73.5-dev, 0.74, 0.74-dev, 0.74.0, 0.74.0-dev, 0.74.1, 0.74.1-dev, 0.74.2, 0.74.2-dev, 0.74.3, 0.74.3-dev, 0.74.4, 0.74.4-dev, 0.74.5, 0.74.5-dev, 0.74.6, 0.74.6-dev, 0.74.7, 0.74.7-dev, latest, latest-dev |
