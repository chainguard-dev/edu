---
title: "Image Overview: temporal-admin-tools-fips"
linktitle: "temporal-admin-tools-fips"
type: "article"
layout: "single"
description: "Overview: temporal-admin-tools-fips Chainguard Image"
...
{{< tabs >}}
{{< tab title="Overview" active=true url="/chainguard/chainguard-images/reference/temporal-admin-tools-fips/" >}}
...
```
docker pull cgr.dev/chainguard-private/temporal-admin-tools-fips:latest
```
