---
title: "Image Overview: redis-fips"
linktitle: "redis-fips"
type: "article"
layout: "single"
description: "Overview: redis-fips Chainguard Image"
...
{{< tabs >}}
{{< tab title="Overview" active=true url="/chainguard/chainguard-images/reference/redis-fips/" >}}
...
```
docker pull cgr.dev/chainguard-private/redis-fips:latest
```
