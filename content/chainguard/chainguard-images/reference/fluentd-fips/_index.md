---
title: "Image Overview: fluentd-fips"
linktitle: "fluentd-fips"
type: "article"
layout: "single"
description: "Overview: fluentd-fips Chainguard Image"
...
{{< tabs >}}
{{< tab title="Overview" active=true url="/chainguard/chainguard-images/reference/fluentd-fips/" >}}
...
```
docker pull cgr.dev/chainguard-private/fluentd-fips:latest
```
