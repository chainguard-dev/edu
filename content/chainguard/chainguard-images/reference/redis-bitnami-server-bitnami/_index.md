---
title: "Image Overview: redis-bitnami-server-bitnami"
linktitle: "redis-bitnami-server-bitnami"
type: "article"
layout: "single"
description: "Overview: redis-bitnami-server-bitnami Chainguard Image"
...
{{< tabs >}}
{{< tab title="Overview" active=true url="/chainguard/chainguard-images/reference/redis-bitnami-server-bitnami/" >}}
...
```
docker pull cgr.dev/chainguard/redis-bitnami-server-bitnami:latest
```
