...
type: "article"
description: "Provenance information for prometheus-node-exporter Chainguard Images"
...
```shell
cosign download sbom --platform linux/amd64 cgr.dev/chainguard/prometheus-node-exporter | jq
```
