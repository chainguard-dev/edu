...
type: "article"
description: "Provenance information for kube-state-metrics Chainguard Images"
...
```shell
cosign download sbom --platform linux/amd64 cgr.dev/chainguard/kube-state-metrics | jq
```
