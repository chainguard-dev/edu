---
title: "kube-state-metrics Image Details"
type: "article"
unlisted: true
description: "Detailed information about the public kube-state-metrics Chainguard Image."
...
{{< tab title="Details" active=true url="/chainguard/chainguard-images/reference/kube-state-metrics/image_specs/" >}}
...
This page shows detailed information about the Chainguard **kube-state-metrics** Image.

|              | latest-dev                    |
|--------------|-------------------------------|
| Default User | `kube-state-metrics`          |
