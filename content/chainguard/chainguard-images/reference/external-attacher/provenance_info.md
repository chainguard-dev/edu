...
type: "article"
description: "Provenance information for External-attacher Chainguard Images"
...
```shell
cosign download sbom --platform linux/amd64 cgr.dev/chainguard/external-attacher | jq
```
