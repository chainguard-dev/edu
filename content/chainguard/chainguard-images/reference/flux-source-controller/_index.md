...
linktitle: "flux-source-controller"
type: "article"
layout: "single"
...
{{< tabs >}}
{{< tab title="Overview" active=true url="/chainguard/chainguard-images/reference/flux-source-controller/" >}}
...
```
docker pull cgr.dev/chainguard-private/flux-source-controller:latest
```
