...
| `cgr.dev/chainguard-private` | 1, 1-dev, 1.0, 1.0-dev, 1.0.0, 1.0.0-dev, 1.0.1, 1.0.1-dev, 1.1, 1.1-dev, 1.1.0, 1.1.0-dev, 1.1.1, 1.1.1-dev, 1.1.2, 1.1.2-dev, 1.2, 1.2-dev, 1.2.0, 1.2.0-dev, 1.2.1, 1.2.1-dev, 1.2.2, 1.2.2-dev, 1.2.3, 1.2.3-dev, 1.2.4, 1.2.4-dev, latest, latest-dev, v1, v1-dev, v1.1, v1.1-dev, v1.1.1, v1.1.1-dev, v1.1.2, v1.1.2-dev, v1.2, v1.2-dev, v1.2.0, v1.2.0-dev, v1.2.1, v1.2.1-dev, v1.2.2, v1.2.2-dev, v1.2.3, v1.2.3-dev, v1.2.4, v1.2.4-dev |
