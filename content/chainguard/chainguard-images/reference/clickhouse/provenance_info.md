...
| `cgr.dev/chainguard-private` | 23, 23-dev, 23.8, 23.8-dev, 23.8.10, 23.8.10-dev, 23.8.10.43, 23.8.10.43-dev, 23.8.11, 23.8.11-dev, 23.8.11.28, 23.8.11.28-dev, 23.8.12, 23.8.12-dev, 23.8.12.13, 23.8.12.13-dev, 23.8.13, 23.8.13-dev, 23.8.13.25, 23.8.13.25-dev, 23.8.14, 23.8.14-dev, 23.8.14.6, 23.8.14.6-dev, 24, 24-dev, 24.1, 24.1-dev, 24.1.5, 24.1.5-dev, 24.1.5.6, 24.1.5.6-dev, 24.2, 24.2-dev, 24.2.1, 24.2.1-dev, 24.2.1.2248, 24.2.1.2248-dev, 24.2.2, 24.2.2-dev, 24.2.2.71, 24.2.2.71-dev, latest, latest-dev |
...
cgr.dev/chainguard-private/clickhouse | jq
```
...
--platform=linux/amd64 \
--predicate-type=https://spdx.dev/Document \
cgr.dev/chainguard-private/clickhouse | jq -r .payload | base64 -d | jq .predicate
```
...
--certificate-oidc-issuer=https://token.actions.githubusercontent.com \
--certificate-identity=https://github.com/chainguard-images/images-private/.github/workflows/release.yaml@refs/heads/main \
cgr.dev/chainguard-private/clickhouse
```
