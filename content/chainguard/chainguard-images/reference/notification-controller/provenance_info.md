...
type: "article"
description: "Provenance information for Notification-controller Chainguard Images"
...
```shell
cosign download sbom --platform linux/amd64 cgr.dev/chainguard/notification-controller | jq
```
