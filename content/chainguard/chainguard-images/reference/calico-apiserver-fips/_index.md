---
title: "Image Overview: calico-apiserver-fips"
linktitle: "calico-apiserver-fips"
type: "article"
layout: "single"
description: "Overview: calico-apiserver-fips Chainguard Image"
...
{{< tabs >}}
{{< tab title="Overview" active=true url="/chainguard/chainguard-images/reference/calico-apiserver-fips/" >}}
...
```
docker pull cgr.dev/chainguard-private/calico-apiserver-fips:latest
```
