...
type: "article"
description: "Provenance information for Aws-efs-csi-driver Chainguard Images"
...
```shell
cosign download sbom --platform linux/amd64 cgr.dev/chainguard/aws-efs-csi-driver | jq
```
