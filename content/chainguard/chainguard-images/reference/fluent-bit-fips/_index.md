---
title: "Image Overview: fluent-bit-fips"
linktitle: "fluent-bit-fips"
type: "article"
layout: "single"
description: "Overview: fluent-bit-fips Chainguard Image"
...
{{< tabs >}}
{{< tab title="Overview" active=true url="/chainguard/chainguard-images/reference/fluent-bit-fips/" >}}
...
```
docker pull cgr.dev/chainguard-private/fluent-bit-fips:latest
```
