...
type: "article"
description: "Provenance information for Kubernetes-csi-livenessprobe Chainguard Images"
...
```shell
cosign download sbom --platform linux/amd64 cgr.dev/chainguard/kubernetes-csi-livenessprobe | jq
```
