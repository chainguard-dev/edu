...
type: "article"
description: "Provenance information for Prometheus-operator Chainguard Images"
...
```shell
cosign download sbom --platform linux/amd64 cgr.dev/chainguard/prometheus-operator | jq
```
