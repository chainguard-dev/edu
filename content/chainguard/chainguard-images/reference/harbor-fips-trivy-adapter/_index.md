---
title: "Image Overview: harbor-fips-trivy-adapter"
linktitle: "harbor-fips-trivy-adapter"
type: "article"
layout: "single"
description: "Overview: harbor-fips-trivy-adapter Chainguard Image"
...
{{< tabs >}}
{{< tab title="Overview" active=true url="/chainguard/chainguard-images/reference/harbor-fips-trivy-adapter/" >}}
...
```
docker pull cgr.dev/chainguard-private/harbor-fips-trivy-adapter:latest
```
