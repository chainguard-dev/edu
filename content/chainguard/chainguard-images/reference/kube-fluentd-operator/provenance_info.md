...
type: "article"
description: "Provenance information for Kube-fluentd-operator Chainguard Images"
...
```shell
cosign download sbom --platform linux/amd64 cgr.dev/chainguard/kube-fluentd-operator | jq
```
