...
type: "article"
description: "Provenance information for Flux-image-reflector-controller Chainguard Images"
...
menu:
  docs:
    parent: "flux-image-reflector-controller"
weight: 600
toc: true
---
...
```shell
cosign download sbom --platform linux/amd64 cgr.dev/chainguard/flux-image-reflector-controller | jq
```
