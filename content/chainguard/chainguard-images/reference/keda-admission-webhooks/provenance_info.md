...
| `cgr.dev/chainguard-private` | 2, 2-dev, 2.10, 2.10-dev, 2.10.1, 2.10.1-dev, 2.11, 2.11-dev, 2.11.0, 2.11.0-dev, 2.11.1, 2.11.1-dev, 2.11.2, 2.11.2-dev, 2.12, 2.12-dev, 2.12.0, 2.12.0-dev, 2.12.1, 2.12.1-dev, 2.13, 2.13-dev, 2.13.0, 2.13.0-dev, 2.13.1, 2.13.1-dev, 2.14, 2.14-dev, 2.14.0, 2.14.0-dev, latest, latest-dev |
