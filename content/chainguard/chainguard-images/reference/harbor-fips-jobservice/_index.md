---
title: "Image Overview: harbor-fips-jobservice"
linktitle: "harbor-fips-jobservice"
type: "article"
layout: "single"
description: "Overview: harbor-fips-jobservice Chainguard Image"
...
{{< tabs >}}
{{< tab title="Overview" active=true url="/chainguard/chainguard-images/reference/harbor-fips-jobservice/" >}}
...
```
docker pull cgr.dev/chainguard-private/harbor-fips-jobservice:latest
```
