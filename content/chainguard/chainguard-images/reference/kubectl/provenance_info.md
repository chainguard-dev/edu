...
| `cgr.dev/chainguard-private` | 1, 1-dev, 1.27, 1.27-dev, 1.27.15, 1.27.15-dev, 1.28, 1.28-dev, 1.28.11, 1.28.11-dev, 1.29, 1.29-dev, 1.29.5, 1.29.5-dev, 1.30, 1.30-dev, 1.30.2, 1.30.2-dev, latest, latest-dev |
