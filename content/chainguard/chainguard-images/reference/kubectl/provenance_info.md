...
### Registry and Tags for kubectl Image
Attestations are provided per image build, so you'll need to specify the correct tag and registry when pulling attestations from an image with `cosign`.

| Registry                     | Tags                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
|------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `cgr.dev/chainguard`         | latest, latest-dev                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| `cgr.dev/chainguard-private` | 1, 1-dev, 1.25, 1.25-dev, 1.25.13, 1.25.13-dev, 1.25.14, 1.25.14-dev, 1.25.15, 1.25.15-dev, 1.25.16, 1.25.16-dev, 1.26, 1.26-dev, 1.26.10, 1.26.10-dev, 1.26.11, 1.26.11-dev, 1.26.12, 1.26.12-dev, 1.26.13, 1.26.13-dev, 1.26.14, 1.26.14-dev, 1.26.15, 1.26.15-dev, 1.26.8, 1.26.8-dev, 1.26.9, 1.26.9-dev, 1.27, 1.27-dev, 1.27.1, 1.27.10, 1.27.10-dev, 1.27.11, 1.27.11-dev, 1.27.12, 1.27.12-dev, 1.27.13, 1.27.13-dev, 1.27.14, 1.27.14-dev, 1.27.2, 1.27.2-dev, 1.27.3, 1.27.3-dev, 1.27.5, 1.27.5-dev, 1.27.6, 1.27.6-dev, 1.27.7, 1.27.7-dev, 1.27.8, 1.27.8-dev, 1.27.9, 1.27.9-dev, 1.28, 1.28-dev, 1.28.0, 1.28.0-dev, 1.28.1, 1.28.1-dev, 1.28.10, 1.28.10-dev, 1.28.2, 1.28.2-dev, 1.28.3, 1.28.3-dev, 1.28.4, 1.28.4-dev, 1.28.5, 1.28.5-dev, 1.28.6, 1.28.6-dev, 1.28.7, 1.28.7-dev, 1.28.8, 1.28.8-dev, 1.28.9, 1.28.9-dev, 1.29, 1.29-dev, 1.29.1, 1.29.1-dev, 1.29.2, 1.29.2-dev, 1.29.3, 1.29.3-dev, 1.29.4, 1.29.4-dev, 1.29.5, 1.29.5-dev, 1.30, 1.30-dev, 1.30.0, 1.30.0-dev, 1.30.1, 1.30.1-dev, latest, latest-dev |
...
cgr.dev/chainguard-private/kubectl | jq
```
...
--platform=linux/amd64 \
--predicate-type=https://spdx.dev/Document \
cgr.dev/chainguard-private/kubectl | jq -r .payload | base64 -d | jq .predicate
```
...
--certificate-oidc-issuer=https://token.actions.githubusercontent.com \
--certificate-identity=https://github.com/chainguard-images/images-private/.github/workflows/release.yaml@refs/heads/main \
cgr.dev/chainguard-private/kubectl
```
