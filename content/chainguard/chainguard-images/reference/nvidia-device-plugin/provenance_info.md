...
type: "article"
description: "Provenance information for Nvidia-device-plugin Chainguard Images"
...
```shell
cosign download sbom --platform linux/amd64 cgr.dev/chainguard/nvidia-device-plugin | jq
```
