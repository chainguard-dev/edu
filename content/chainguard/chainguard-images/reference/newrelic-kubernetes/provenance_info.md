...
type: "article"
description: "Provenance information for Newrelic-kubernetes Chainguard Images"
...
```shell
cosign download sbom --platform linux/amd64 cgr.dev/chainguard/newrelic-kubernetes | jq
```
