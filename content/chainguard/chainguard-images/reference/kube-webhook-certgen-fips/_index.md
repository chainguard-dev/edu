---
title: "Image Overview: kube-webhook-certgen-fips"
linktitle: "kube-webhook-certgen-fips"
type: "article"
layout: "single"
description: "Overview: kube-webhook-certgen-fips Chainguard Image"
...
{{< tabs >}}
{{< tab title="Overview" active=true url="/chainguard/chainguard-images/reference/kube-webhook-certgen-fips/" >}}
...
```
docker pull cgr.dev/chainguard-private/kube-webhook-certgen-fips:latest
```
