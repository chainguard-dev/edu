...
{{< tab title="Details" active=true url="/chainguard/chainguard-images/reference/mlflow/image_specs/" >}}
...
This page shows detailed information about the Chainguard **mlflow** Image.
...
Check the [tags history page](/chainguard/chainguard-images/reference/mlflow/tags_history/) for the full list of available tags.
