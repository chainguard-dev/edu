---
title: "gha-runner-scale-set-controller Image Details"
type: "article"
unlisted: true
...
{{< tab title="Details" active=true url="/chainguard/chainguard-images/reference/gha-runner-scale-set-controller/image_specs/" >}}
...
This page shows detailed information about the Chainguard **gha-runner-scale-set-controller** Image.
...
Check the [tags history page](/chainguard/chainguard-images/reference/gha-runner-scale-set-controller/tags_history/) for the full list of available tags.
...
|                                    | latest-dev | latest |
|------------------------------------|------------|--------|
| `actions-runner-controller`        | X          | X      |
| `actions-runner-controller-compat` | X          | X      |
| `apk-tools`                        | X          |        |
| `bash`                             | X          |        |
| `busybox`                          | X          |        |
