---
title: "Provenance Information for musl-dynamic Images"
type: "article"
description: "Provenance information for Musl-dynamic Chainguard Images"
...
The **musl-dynamic** Chainguard Images are signed using Sigstore, and you can check the included signatures using `cosign`.
...
```shell
cosign download sbom --platform linux/amd64 cgr.dev/chainguard/musl-dynamic | jq
```
