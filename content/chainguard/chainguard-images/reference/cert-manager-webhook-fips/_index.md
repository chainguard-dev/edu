---
title: "Image Overview: cert-manager-webhook-fips"
linktitle: "cert-manager-webhook-fips"
type: "article"
layout: "single"
description: "Overview: cert-manager-webhook-fips Chainguard Image"
...
{{< tabs >}}
{{< tab title="Overview" active=true url="/chainguard/chainguard-images/reference/cert-manager-webhook-fips/" >}}
...
```
docker pull cgr.dev/chainguard-private/cert-manager-webhook-fips:latest
```
