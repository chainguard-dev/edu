---
title: "Image Overview: harbor-core"
linktitle: "harbor-core"
type: "article"
layout: "single"
description: "Overview: harbor-core Chainguard Image"
...
{{< tabs >}}
{{< tab title="Overview" active=true url="/chainguard/chainguard-images/reference/harbor-core/" >}}
...
```
docker pull cgr.dev/chainguard-private/harbor-core:latest
```
