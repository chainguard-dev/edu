...
type: "article"
description: "Provenance information for Kube-downscaler Chainguard Images"
...
```shell
cosign download sbom --platform linux/amd64 cgr.dev/chainguard/kube-downscaler | jq
```
