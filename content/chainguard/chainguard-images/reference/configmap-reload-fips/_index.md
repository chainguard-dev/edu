---
title: "Image Overview: configmap-reload-fips"
linktitle: "configmap-reload-fips"
type: "article"
layout: "single"
description: "Overview: configmap-reload-fips Chainguard Image"
...
{{< tabs >}}
{{< tab title="Overview" active=true url="/chainguard/chainguard-images/reference/configmap-reload-fips/" >}}
...
```
docker pull cgr.dev/chainguard-private/configmap-reload-fips:latest
```
