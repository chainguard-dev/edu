...
| `cgr.dev/chainguard-private` | 1, 1-dev, 1.7, 1.7-dev, 1.7.4, 1.7.4-dev, 1.8, 1.8-dev, 1.8.0, 1.8.0-dev, 1.8.1, 1.8.1-dev, 1.8.2, 1.8.2-dev, 1.8.3, 1.8.3-dev, 1.8.4, 1.8.4-dev, 1.9, 1.9-dev, 1.9.0, 1.9.0-dev, latest, latest-dev |
