...
| Entrypoint   | `/usr/bin/xfn` | `/usr/bin/xfn` |
| CMD          | not specified  | not specified  |
| Workdir      | not specified  | not specified  |
| Has apk?     | yes            | no             |
| Has a shell? | yes            | no             |

Check the [tags history page](/chainguard/chainguard-images/reference/crossplane-xfn/tags_history/) for the full list of available tags.
