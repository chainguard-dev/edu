---
title: "Image Overview: calico-csi-fips"
linktitle: "calico-csi-fips"
type: "article"
layout: "single"
description: "Overview: calico-csi-fips Chainguard Image"
...
{{< tabs >}}
{{< tab title="Overview" active=true url="/chainguard/chainguard-images/reference/calico-csi-fips/" >}}
...
```
docker pull cgr.dev/chainguard-private/calico-csi-fips:latest
```
