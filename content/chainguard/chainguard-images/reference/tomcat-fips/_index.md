---
title: "Image Overview: tomcat-fips"
linktitle: "tomcat-fips"
type: "article"
layout: "single"
description: "Overview: tomcat-fips Chainguard Image"
...
{{< tabs >}}
{{< tab title="Overview" active=true url="/chainguard/chainguard-images/reference/tomcat-fips/" >}}
...
```
docker pull cgr.dev/chainguard-private/tomcat-fips:latest
```
