...
type: "article"
description: "Provenance information for Cluster-proportional-autoscaler Chainguard Images"
...
```shell
cosign download sbom --platform linux/amd64 cgr.dev/chainguard/cluster-proportional-autoscaler | jq
```
