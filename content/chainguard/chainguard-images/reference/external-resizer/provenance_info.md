...
type: "article"
description: "Provenance information for External-resizer Chainguard Images"
...
```shell
cosign download sbom --platform linux/amd64 cgr.dev/chainguard/external-resizer | jq
```
