---
title: "Image Overview: consul-fips"
linktitle: "consul-fips"
type: "article"
layout: "single"
description: "Overview: consul-fips Chainguard Image"
...
{{< tabs >}}
{{< tab title="Overview" active=true url="/chainguard/chainguard-images/reference/consul-fips/" >}}
...
```
docker pull cgr.dev/chainguard-private/consul-fips:latest
```
