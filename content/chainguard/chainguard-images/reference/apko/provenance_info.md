...
| `cgr.dev/chainguard-private` | 0, 0-dev, 0.10, 0.10.0, 0.11, 0.11-dev, 0.11.0, 0.11.0-dev, 0.11.1, 0.11.1-dev, 0.11.2, 0.11.2-dev, 0.11.3, 0.11.3-dev, 0.12, 0.12-dev, 0.12.0, 0.12.0-dev, 0.13, 0.13-dev, 0.13.1, 0.13.1-dev, 0.13.2, 0.13.2-dev, 0.13.3, 0.13.3-dev, 0.14, 0.14-dev, 0.14.0, 0.14.0-dev, 0.14.1, 0.14.1-dev, 0.14.2, 0.14.2-dev, 0.7, 0.7.3, 0.8, 0.8.0, 0.9, 0.9.0, latest, latest-dev |
