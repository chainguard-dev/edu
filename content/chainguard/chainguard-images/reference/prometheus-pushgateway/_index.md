...
linktitle: "prometheus-pushgateway"
type: "article"
layout: "single"
...
{{< tabs >}}
{{< tab title="Overview" active=true url="/chainguard/chainguard-images/reference/prometheus-pushgateway/" >}}
...
```
docker pull cgr.dev/chainguard/prometheus-pushgateway:latest
```
