---
title: "Image Overview: karpenter-fips"
linktitle: "karpenter-fips"
type: "article"
layout: "single"
description: "Overview: karpenter-fips Chainguard Image"
...
{{< tabs >}}
{{< tab title="Overview" active=true url="/chainguard/chainguard-images/reference/karpenter-fips/" >}}
...
```
docker pull cgr.dev/chainguard-private/karpenter-fips:latest
```
