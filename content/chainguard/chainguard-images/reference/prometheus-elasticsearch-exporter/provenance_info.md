...
type: "article"
description: "Provenance information for Prometheus-elasticsearch-exporter Chainguard Images"
...
```shell
cosign download sbom --platform linux/amd64 cgr.dev/chainguard/prometheus-elasticsearch-exporter | jq
```
