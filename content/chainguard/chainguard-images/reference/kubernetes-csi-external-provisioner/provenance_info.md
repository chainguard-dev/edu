...
type: "article"
description: "Provenance information for Kubernetes-csi-external-provisioner Chainguard Images"
...
```shell
cosign download sbom --platform linux/amd64 cgr.dev/chainguard/kubernetes-csi-external-provisioner | jq
```
