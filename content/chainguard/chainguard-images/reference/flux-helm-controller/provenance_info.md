...
| `cgr.dev/chainguard-private` | 0, 0-dev, 0.35, 0.35-dev, 0.35.0, 0.35.0-dev, 0.36, 0.36-dev, 0.36.0, 0.36.0-dev, 0.36.1, 0.36.1-dev, 0.36.2, 0.36.2-dev, 0.37, 0.37-dev, 0.37.0, 0.37.0-dev, 0.37.1, 0.37.1-dev, 0.37.2, 0.37.2-dev, 0.37.3, 0.37.3-dev, 0.37.4, 0.37.4-dev, 1, 1-dev, 1.0, 1.0-dev, 1.0.1, 1.0.1-dev, latest, latest-dev, v0, v0-dev, v0.36, v0.36-dev, v0.36.1, v0.36.1-dev, v0.36.2, v0.36.2-dev, v0.37, v0.37-dev, v0.37.0, v0.37.0-dev, v0.37.1, v0.37.1-dev, v0.37.2, v0.37.2-dev, v0.37.3, v0.37.3-dev, v0.37.4, v0.37.4-dev |
