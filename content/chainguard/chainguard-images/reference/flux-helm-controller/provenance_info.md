...
type: "article"
description: "Provenance information for Flux-helm-controller Chainguard Images"
...
```shell
cosign download sbom --platform linux/amd64 cgr.dev/chainguard/flux-helm-controller | jq
```
