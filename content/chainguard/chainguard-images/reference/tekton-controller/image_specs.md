---
title: "tekton-controller Image Details"
type: "article"
unlisted: true
description: "Detailed information about the public tekton-controller Chainguard Image."
...
{{< tab title="Details" active=true url="/chainguard/chainguard-images/reference/tekton-controller/image_specs/" >}}
...
This page shows detailed information about the Chainguard **tekton-controller** Image.

|              | latest-dev                             |
|--------------|----------------------------------------|
| Default User | `nonroot`                              |
| Entrypoint   | `/usr/bin/tekton-pipelines-controller` |
| CMD          | not specified                          |
