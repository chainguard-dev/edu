...
type: "article"
description: "Provenance information for Prometheus-postgres-exporter Chainguard Images"
...
```shell
cosign download sbom --platform linux/amd64 cgr.dev/chainguard/prometheus-postgres-exporter | jq
```
