---
title: "Image Overview: node-fips"
linktitle: "node-fips"
type: "article"
layout: "single"
description: "Overview: node-fips Chainguard Image"
...
{{< tabs >}}
{{< tab title="Overview" active=true url="/chainguard/chainguard-images/reference/node-fips/" >}}
...
```
docker pull cgr.dev/chainguard-private/node-fips:latest
```
