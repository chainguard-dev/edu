---
title: "Image Overview: cilium-hubble-ui-backend-fips"
linktitle: "cilium-hubble-ui-backend-fips"
type: "article"
layout: "single"
description: "Overview: cilium-hubble-ui-backend-fips Chainguard Image"
...
{{< tabs >}}
{{< tab title="Overview" active=true url="/chainguard/chainguard-images/reference/cilium-hubble-ui-backend-fips/" >}}
...
```
docker pull cgr.dev/chainguard-private/cilium-hubble-ui-backend-fips:latest
```
