---
title: "Image Overview: sigstore-scaffolding-ctlog-createctconfig-fips"
linktitle: "sigstore-scaffolding-ctlog-createctconfig-fips"
type: "article"
layout: "single"
description: "Overview: sigstore-scaffolding-ctlog-createctconfig-fips Chainguard Image"
...
{{< tabs >}}
{{< tab title="Overview" active=true url="/chainguard/chainguard-images/reference/sigstore-scaffolding-ctlog-createctconfig-fips/" >}}
...
```
docker pull cgr.dev/chainguard-private/sigstore-scaffolding-ctlog-createctconfig-fips:latest
```
