---
title: "Image Overview: prometheus-node-exporter-fips"
linktitle: "prometheus-node-exporter-fips"
type: "article"
layout: "single"
description: "Overview: prometheus-node-exporter-fips Chainguard Image"
...
{{< tabs >}}
{{< tab title="Overview" active=true url="/chainguard/chainguard-images/reference/prometheus-node-exporter-fips/" >}}
...
```
docker pull cgr.dev/chainguard-private/prometheus-node-exporter-fips:latest
```
