---
title: "Image Overview: calico-node-driver-registrar-fips"
linktitle: "calico-node-driver-registrar-fips"
type: "article"
layout: "single"
description: "Overview: calico-node-driver-registrar-fips Chainguard Image"
...
{{< tabs >}}
{{< tab title="Overview" active=true url="/chainguard/chainguard-images/reference/calico-node-driver-registrar-fips/" >}}
...
```
docker pull cgr.dev/chainguard-private/calico-node-driver-registrar-fips:latest
```
