---
title: "sigstore-scaffolding-tuf-server Image Details"
type: "article"
unlisted: true
description: "Detailed information about the public sigstore-scaffolding-tuf-server Chainguard Image."
...
{{< tab title="Details" active=true url="/chainguard/chainguard-images/reference/sigstore-scaffolding-tuf-server/image_specs/" >}}
...
This page shows detailed information about the Chainguard **sigstore-scaffolding-tuf-server** Image.
...
| `sigstore-scaffolding-tuf-server` | X          |
| `wget`                            | X          |
| `wolfi-baselayout`                | X          |
| `zlib`                            | X          |
