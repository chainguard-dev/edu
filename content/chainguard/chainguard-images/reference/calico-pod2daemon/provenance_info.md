...
type: "article"
description: "Provenance information for Calico-pod2daemon Chainguard Images"
...
```shell
cosign download sbom --platform linux/amd64 cgr.dev/chainguard/calico-pod2daemon | jq
```
