...
type: "article"
description: "Provenance information for Helm-controller Chainguard Images"
...
```shell
cosign download sbom --platform linux/amd64 cgr.dev/chainguard/helm-controller | jq
```
