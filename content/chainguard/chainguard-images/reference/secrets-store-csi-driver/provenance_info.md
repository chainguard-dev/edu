...
type: "article"
description: "Provenance information for secrets-store-csi-driver Chainguard Images"
...
```shell
cosign download sbom --platform linux/amd64 cgr.dev/chainguard/secrets-store-csi-driver | jq
```
