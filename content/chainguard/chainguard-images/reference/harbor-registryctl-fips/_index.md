---
title: "Image Overview: harbor-registryctl-fips"
linktitle: "harbor-registryctl-fips"
type: "article"
layout: "single"
description: "Overview: harbor-registryctl-fips Chainguard Image"
...
{{< tabs >}}
{{< tab title="Overview" active=true url="/chainguard/chainguard-images/reference/harbor-registryctl-fips/" >}}
...
```
docker pull cgr.dev/chainguard-private/harbor-registryctl-fips:latest
```
