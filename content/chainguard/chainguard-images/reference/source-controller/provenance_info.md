...
type: "article"
description: "Provenance information for Source-controller Chainguard Images"
...
```shell
cosign download sbom --platform linux/amd64 cgr.dev/chainguard/source-controller | jq
```
