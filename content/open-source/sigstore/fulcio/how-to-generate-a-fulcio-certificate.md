...
Also, please note that using Cosign requires Go v1.16 or higher. The Go Project provides [official download instructions](https://go.dev/doc/install).
...
After authentication, you can close the browser tab. In your terminal, you will see output similar to this:
