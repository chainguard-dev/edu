...
Software teams should select base images with as few known vulnerabilities as possible. This not only has the security benefits but also reduces the toil imposed on the team by having to manually triage vulnerabilities, determining whether the vulnerability is a true positive and false positive and whether the vulnerability is exploitable in the context of the deployed application.
