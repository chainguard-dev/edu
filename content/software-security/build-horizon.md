...
- [Strategies and tooling for updating containers](/chainguard/chainguard-images/staying-secure/updating-images/strategies-tools-updating-images/) — which outlines different strategies and tools for keeping images up to date and avoiding the use of end-of-life software.
