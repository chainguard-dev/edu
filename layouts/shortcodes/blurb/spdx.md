[System Package Data Exchange (SPDX)](https://spdx.dev/) is a file format for representing Software Bills of Materials (SBOMs), or itemized metadata on packages contained in a software artifact.
